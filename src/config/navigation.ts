import { Activity, Award, Badge, Bot, BarChart3, Gift, Medal, ScrollText, Star, Trophy, User, Users } from 'lucide-react';
...
export const appNavigationGroups: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      { labelKey: 'nav.items.cards', shortLabelKey: 'nav.items.cardsShort', to: '/cards', icon: Badge },
