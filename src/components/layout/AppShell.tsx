...
export default function AppShell({ children, themeControls, fullHeight = false }: AppShellProps) {
  ...
  return (
    <div className={`${fullHeight ? 'h-[100dvh]' : 'min-h-screen'} bg-page flex font-sans relative overflow-hidden`}>
      ...
      <div data-app-scroll-root className="flex-1 min-w-0 min-h-0 flex flex-col pb-[var(--mobile-scroll-clearance)] lg:pb-0 h-[100dvh] overflow-y-auto relative z-10 scroll-pb-[var(--mobile-scroll-clearance)] lg:scroll-pb-0" style={{ '--mobile-scroll-clearance': mobileScrollClearance } as React.CSSProperties}>
