...
export default function SquadPitchBuilder({ formation, assignments, ownedCards, loading = false, error = null, onFormationChange, onAssignmentsChange }: Props) {
