...
const formations: Record<FormationKey, SquadSlot[]> = {
  '4-3-3': [
    ...
    { id: 'cm1', label: 'CM', line: 'mid', x: 28, y: 44 },
    { id: 'cm2', label: 'CM', line: 'mid', x: 50, y: 47 },
    { id: 'cm3', label: 'CM', line: 'mid', x: 72, y: 44 },
  ...
  '4-4-2': [
    ...
    { id: 'cb2', label: 'CB', line: 'def', x: 62, y: 64 },
    { id: 'rb', label: 'RB', line: 'def', x: 86, y: 62 },
    { id: 'lm', label: 'LM', line: 'mid', x: 14, y: 43 },
    { id: 'cm1', label: 'CM', line: 'mid', x: 38, y: 46 },
    { id: 'cm2', label: 'CM', line: 'mid', x: 62, y: 46 },
    { id: 'rm', label: 'RM', line: 'mid', x: 86, y: 43 },
  ...
  '3-5-2': [
    ...
    { id: 'lm', label: 'LM', line: 'mid', x: 14, y: 44 },
    { id: 'cm1', label: 'CM', line: 'mid', x: 34, y: 47 },
    { id: 'cam', label: 'CAM', line: 'mid', x: 50, y: 41 },
    { id: 'cm2', label: 'CM', line: 'mid', x: 66, y: 47 },
    { id: 'rm', label: 'RM', line: 'mid', x: 86, y: 44 },
    { id: 'st1', label: 'ST', line: 'att', x: 38, y: 20 },
    { id: 'st2', label: 'ST', line: 'att', x: 62, y: 20 },
  ],
};
