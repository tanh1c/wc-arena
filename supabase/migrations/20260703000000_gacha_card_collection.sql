...
insert into public.player_cards (
  ...
  ('Doan', 'RM', 'CAM,CM', 'Japan', 'International', 'Japan', '(4) ★★★★', 'LEFT / (3) ★★★', '5''8" (172 cm)', '74 kg', 'High', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YquUVg.png', 'Rare'),
  ('Salah', 'RW', 'RM', 'Egypt', 'International', 'Egypt', '(4) ★★★★', 'LEFT / (4) ★★★★', '5''9" (175 cm)', '72 kg', 'High', 'Medium', date '2026-06-10', 'https://s6.imgcdn.dev/Yqulpv.png', 'Icon'),
  ('Marmoush', 'LW', 'ST', 'Egypt', 'International', 'Egypt', '(4) ★★★★', 'RIGHT / (4) ★★★★', '6''0" (183 cm)', '81 kg', 'High', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YquayN.png', 'Rare'),
  ('Wood', 'ST', null, 'New Zealand', 'International', 'New Zealand', '(3) ★★★', 'RIGHT / (3) ★★★', '6''3" (191 cm)', '92 kg', 'High', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/Yqu12q.png', 'Common'),
  ...
  ('Saliba', 'CB', null, 'France', 'International', 'France', '(2) ★★', 'RIGHT / (3) ★★★', '6''4" (193 cm)', '85 kg', 'Medium', 'High', date '2026-06-10', 'https://s6.imgcdn.dev/YquGBL.png', 'Common'),
  ...
  ('Koulibaly', 'CB', null, 'Senegal', 'International', 'Senegal', '(3) ★★★', 'RIGHT / (4) ★★★★', '6''1" (186 cm)', '89 kg', 'Medium', 'High', date '2026-06-10', 'https://s6.imgcdn.dev/YqIY2N.png', 'Rare'),
  ('Laimer', 'RB', 'CDM,LB', 'Austria', 'International', 'Austria', '(3) ★★★', 'RIGHT / (3) ★★★', '5''11" (180 cm)', '72 kg', 'Medium', 'Medium', date '2026-06-10', 'https://s6.imgcdn.dev/YqIhHq.png', 'Common'),
  ('Arnautović', 'ST', null, 'Austria', 'International', 'Austria', '(4) ★★★★', 'RIGHT / (4) ★★★★', '6''4" (192 cm)', '83 kg', 'High', 'Low', date '2026-07-01', 'https://s6.imgcdn.dev/YqIwIB.png', 'Rare'),
  ('Wimmer', 'LM', 'CAM,CM', 'Austria', 'International', 'Austria', '(5) ★★★★★', 'RIGHT / (4) ★★★★', '6''0" (182 cm)', '77 kg', 'Medium', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YqI6Bu.png', 'Epic'),
  ('Yusupov', 'GK', null, 'Uzbekistan', 'International', 'Uzbekistan', '(1) ★', 'RIGHT / (3) ★★★', '6''1" (185 cm)', '83 kg', 'Medium', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YqIMLL.png', 'Common'),
  ('Khusanov', 'CB', null, 'Uzbekistan', 'International', 'Uzbekistan', '(2) ★★', 'RIGHT / (3) ★★★', '6''1" (186 cm)', '84 kg', 'Medium', 'Medium', date '2026-06-04', 'https://s6.imgcdn.dev/YqIu6a.png', 'Common'),
  ('Shomurodov', 'ST', 'CAM', 'Uzbekistan', 'International', 'Uzbekistan', '(3) ★★★', 'RIGHT / (4) ★★★★', '6''3" (190 cm)', '76 kg', 'Medium', 'Medium', date '2026-06-10', 'https://s6.imgcdn.dev/YqI4lw.png', 'Rare'),
  ('Mbemba', 'CB', null, 'Congo DR', 'International', 'DR Congo', '(2) ★★', 'RIGHT / (3) ★★★', '6''0" (182 cm)', '81 kg', 'High', 'Medium', date '2026-06-10', 'https://s6.imgcdn.dev/YqICVt.png', 'Common'),
  ('Wissa', 'ST', null, 'Congo DR', 'International', 'DR Congo', '(3) ★★★', 'RIGHT / (3) ★★★', '5''9" (176 cm)', '74 kg', 'Medium', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YqIIpT.png', 'Common'),
  ('Iñaki Williams', 'RW', 'ST,RM', 'Ghana', 'International', 'Ghana', '(4) ★★★★', 'RIGHT / (3) ★★★', '6''1" (186 cm)', '80 kg', 'High', 'Medium', date '2026-06-10', 'https://s6.imgcdn.dev/YqIQyD.png', 'Rare'),
  ('Murillo', 'RB', 'CB', 'Panama', 'International', 'Panama', '(3) ★★★', 'RIGHT / (3) ★★★', '6''0" (184 cm)', '78 kg', 'High', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YqIi29.png', 'Common'),
  ('Carrasquilla', 'CM', 'CAM,RM', 'Panama', 'International', 'Panama', '(3) ★★★', 'RIGHT / (3) ★★★', '5''7" (170 cm)', '64 kg', 'Medium', 'Medium', date '2026-06-10', 'https://s6.imgcdn.dev/YqIkXy.png', 'Common'),
  ('Summerville', 'RW', 'RM', 'Netherlands', 'International', 'Netherlands', '(3) ★★★', 'RIGHT / (3) ★★★', '5''7" (169 cm)', '64 kg', 'High', 'Medium', date '2026-06-24', 'https://s6.imgcdn.dev/YqIsI8.png', 'Common'),
  ('Samú Costa', 'CDM', 'CM', 'Portugal', 'International', 'Portugal', '(2) ★★', 'LEFT / (3) ★★★', '6''0" (183 cm)', '75 kg', 'Medium', 'High', date '2026-06-24', 'https://s6.imgcdn.dev/YqIyB2.png', 'Common'),
  ('Amdouni', 'ST', null, 'Switzerland', 'International', 'Switzerland', '(3) ★★★', 'RIGHT / (4) ★★★★', '6''1" (185 cm)', '79 kg', 'High', 'Low', date '2026-06-24', 'https://s6.imgcdn.dev/YqI5bi.png', 'Rare'),
  ('Mora', 'CAM', 'LW,CM', 'Mexico', 'International', 'Mexico', '(4) ★★★★', 'RIGHT / (3) ★★★', '5''6" (168 cm)', '65 kg', 'High', 'Medium', date '2026-07-03', 'https://s6.imgcdn.dev/YqIP6H.png', 'Rare'),
  ('Alvarado', 'RW', 'RM,LM', 'Mexico', 'International', 'Mexico', '(4) ★★★★', 'LEFT / (4) ★★★★', '5''9" (176 cm)', '70 kg', 'High', 'Medium', date '2026-06-29', 'https://s6.imgcdn.dev/YqITlS.png', 'Rare'),
  ('Manzambi', 'CAM', 'CM,CDM', 'Switzerland', 'International', 'Switzerland', '(4) ★★★★', 'RIGHT / (3) ★★★', '6''0" (183 cm)', '75 kg', 'High', 'Medium', date '2026-06-29', 'https://s6.imgcdn.dev/YqIUfC.png', 'Rare'),
  ('Ayari', 'CDM', 'CM', 'Sweden', 'International', 'Sweden', '(3) ★★★', 'RIGHT / (3) ★★★', '5''8" (172 cm)', '69 kg', 'High', 'High', date '2026-06-17', 'https://s6.imgcdn.dev/YqIay0.png', 'Common'),
  ('Balogun', 'ST', null, 'United States', 'International', 'United States', '(4) ★★★★', 'RIGHT / (4) ★★★★', '5''10" (178 cm)', '66 kg', 'High', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YqI1AM.png', 'Rare'),
  ('Koné', 'CM', null, 'Canada', 'International', 'Canada', '(3) ★★★', 'RIGHT / (4) ★★★★', '6''2" (188 cm)', '76 kg', 'High', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YqI0Xd.png', 'Rare'),
  ('Mané', 'ST', 'LW', 'Senegal', 'International', 'Senegal', '(4) ★★★★', 'RIGHT / (4) ★★★★', '5''9" (174 cm)', '69 kg', 'High', 'Medium', date '2026-07-01', 'https://s6.imgcdn.dev/YqIBNl.png', 'Rare'),
  ('Vózinha', 'GK', null, 'Cabo Verde', 'International', 'Cape Verde Islands', '(1) ★', 'RIGHT / (3) ★★★', '6''2" (189 cm)', '75 kg', 'Medium', 'Medium', date '2026-06-19', 'https://s6.imgcdn.dev/YqIGGh.png', 'Common'),
  ('Just', 'LW', 'RW,CAM', 'New Zealand', 'International', 'New Zealand', '(3) ★★★', 'LEFT / (4) ★★★★', '5''9" (174 cm)', '69 kg', 'High', 'Medium', date '2026-06-19', 'https://s6.imgcdn.dev/YqISbV.png', 'Rare'),
  ('Mostafa Zico', 'LW', 'RW', 'Egypt', 'International', 'Egypt', '(4) ★★★★', 'RIGHT / (4) ★★★★', '6''0" (182 cm)', '74 kg', 'High', 'Medium', date '2026-07-01', 'https://s6.imgcdn.dev/YqIvMK.png', 'Rare'),
  ('Diney', 'CB', null, 'Cabo Verde', 'International', 'Cape Verde Islands', '(2) ★★', 'RIGHT / (3) ★★★', '6''1" (185 cm)', '78 kg', 'Low', 'Medium', date '2026-07-01', 'https://s6.imgcdn.dev/YqIxlo.png', 'Common'),
  ('Livaković', 'GK', null, 'Croatia', 'International', 'Croatia', '(1) ★', 'RIGHT / (2) ★★', '6''2" (188 cm)', '79 kg', 'Medium', 'Medium', date '2026-07-01', 'https://s6.imgcdn.dev/YqI2fO.png', 'Common'),
  ('Alisson', 'GK', null, 'Brazil', 'International', 'Brazil', '(1) ★', 'RIGHT / (3) ★★★', '6''4" (193 cm)', '91 kg', 'Medium', 'Medium', date '2026-06-29', 'https://s6.imgcdn.dev/YqIODn.png', 'Common'),
  ('El Aynaoui', 'CM', 'CDM', 'Morocco', 'International', 'Morocco', '(3) ★★★', 'RIGHT / (3) ★★★', '6''1" (185 cm)', '77 kg', 'High', 'High', date '2026-06-29', 'https://s6.imgcdn.dev/YqIZyg.png', 'Common'),
  ('Singo', 'CB', 'RB', 'Côte d''Ivoire', 'International', 'Ivory Coast', '(3) ★★★', 'RIGHT / (2) ★★', '6''3" (190 cm)', '79 kg', 'High', 'Medium', date '2026-06-29', 'https://s6.imgcdn.dev/YqI9Av.png', 'Common'),
  ('Sarr', 'RW', 'CAM', 'Senegal', 'International', 'Senegal', '(4) ★★★★', 'RIGHT / (3) ★★★', '6''1" (185 cm)', '70 kg', 'High', 'Medium', date '2026-06-29', 'https://s6.imgcdn.dev/YqIRgN.png', 'Rare'),
  ('Okon', 'CB', null, 'South Africa', 'International', 'South Africa', '(2) ★★', 'RIGHT / (3) ★★★', '6''2" (187 cm)', '86 kg', 'Medium', 'High', date '2026-06-29', 'https://s6.imgcdn.dev/YqIfNq.png', 'Common'),
  ('Saliba', 'CM', 'CDM', 'Canada', 'International', 'Canada', '(3) ★★★', 'RIGHT / (5) ★★★★★', '5''8" (173 cm)', '71 kg', 'High', 'Medium', date '2026-06-29', 'https://s6.imgcdn.dev/YqItGB.png', 'Epic'),
  ('Berhalter', 'CM', 'RM,CDM', 'United States', 'International', 'United States', '(2) ★★', 'RIGHT / (3) ★★★', '5''9" (175 cm)', '70 kg', 'Medium', 'High', date '2026-07-01', 'https://s6.imgcdn.dev/YqIWeu.png', 'Common'),
  ('Ajer', 'CB', 'RB,LB', 'Norway', 'International', 'Norway', '(3) ★★★', 'RIGHT / (3) ★★★', '6''5" (196 cm)', '84 kg', 'Medium', 'High', date '2026-07-03', 'https://s6.imgcdn.dev/YqILza.png', 'Common'),
  ('Saka', 'RW', 'RM', 'England', 'International', 'England', '(3) ★★★', 'LEFT / (4) ★★★★', '5''10" (178 cm)', '65 kg', 'High', 'Medium', date '2026-06-10', 'https://s6.imgcdn.dev/YqIbtw.png', 'Rare'),
  ('Álvarez', 'CDM', 'CM,CB', 'Mexico', 'International', 'Mexico', '(2) ★★', 'RIGHT / (2) ★★', '6''2" (187 cm)', '73 kg', 'Medium', 'High', date '2026-06-03', 'https://s6.imgcdn.dev/YqImDt.png', 'Common'),
  ('Nuno Mendes', 'LB', null, 'Portugal', 'International', 'Portugal', '(3) ★★★', 'LEFT / (4) ★★★★', '5''11" (180 cm)', '70 kg', 'High', 'Medium', date '2026-06-17', 'https://s6.imgcdn.dev/YqIq5T.png', 'Rare'),
  ('Vitinha', 'CM', 'CDM', 'Portugal', 'International', 'Portugal', '(4) ★★★★', 'RIGHT / (4) ★★★★', '5''8" (172 cm)', '64 kg', 'High', 'High', date '2026-06-10', 'https://s6.imgcdn.dev/YqIFOD.png', 'Rare')
